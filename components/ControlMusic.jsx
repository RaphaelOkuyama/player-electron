// components/ControlMusic.jsx

import { useRef, useState } from "react";
import NextIcon from "./icons/NextIcon"; // Adicionado
import PauseIcon from "./icons/PauseIcon"; // Adicionado
import PlayIcon from "./icons/PlayIcon"; // Adicionado
import PreviousIcon from "./icons/PreviousIcon"; // Adicionado
    ...
    <div className="w-96 h-14 px-8 flex-col justify-center items-center gap-4 inline-flex">
      ...
      <div className="self-stretch justify-start items-center gap-8 inline-flex">
        ...
        <div className="w-96 h-1 relative bg-neutral-600 rounded-full">
          <div id="progress-bar" className="w-1 h-1 rounded-full bg-white absolute top-1/2 transform -translate-y-1/2"/>
        </div>
        <div className="text-center text-xs text-white font-semibold leading-tight tracking-wide">
          <p>00:00</p>
        </div>
